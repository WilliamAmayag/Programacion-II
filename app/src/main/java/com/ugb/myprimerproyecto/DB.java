...
public class DB extends SQLiteOpenHelper {
    ...
    static String tblus = "CREATE TABLE tblusuario(idusuario integer primary key, nombre text, dui text, telefono text, mail text, pass text, permiso text)";
    ...
    public Cursor agregar_usuario(String accion, String[] datos){
        ...
        switch (accion){
            case "nuevo":
                sqLiteDatabaseW.execSQL("INSERT INTO tblusuario(idusuario,nombre, dui, telefono, mail, pass, permiso) VALUES ('"+datos[0]+"','"+datos[1]+"','"+datos[2]+"','"+datos[3]+"','"+datos[4]+"','"+datos[5]+"','"+datos[6]+"')");
                break;
        }
